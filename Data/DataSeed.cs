    ...
    public static class DataSeed
    {
        ...
        private static async Task SeedArtifactsAsync(ApplicationDbContext context)
        {
            if (!context.Artifacts.Any())
            {
                ...
                var artifacts = JsonSerializer.Deserialize<List<Artifact>>(json, options);
        ...
        public static async Task SeedCatalogRecordsAsync(IServiceProvider svcProvider)
        {
            ...
            var userManager = svcProvider.GetRequiredService<UserManager<User>>();
            ...
            foreach (var fileName in files)
            {
                ...
                foreach (var recordImport in records)
                {
                    ...
                    var catalogRecord = new CatalogRecord
                    {
                        ...
                        CatalogStatus = recordImport.Status,
     ...
     SELECT setval(
        ...
        private static async Task AddClaimIfNotExists(UserManager<User> userManager, User user, string claimType, string claimValue)
        {
